...
export const TEMPLATES: Record<string, { id:string; label:string; desc:string; img:string; prompt:string }[]> = {
  ...
  babies: [
    { id:"momchild-happy-piggyback", label:"Happy Piggyback", desc:"White Studio Cuddle",
      img: new URL("@/assets/templates/babies/momchild-happy-piggyback.jpg", import.meta.url).href,
      prompt:"as a realistic studio family portrait — young mother in white button-down shirt and light blue jeans sitting cross-legged barefoot on the floor, hugging her smiling toddler son close to her cheek, both in white shirts and jeans, plain seamless white studio backdrop, soft natural studio lighting, photorealistic skin texture, professional family photography" },
    { id:"momchild-grateful-love", label:"Grateful Love", desc:"Tulips & Hand Kiss",
      img: new URL("@/assets/templates/babies/momchild-grateful-love.jpg", import.meta.url).href,
      prompt:"as a realistic studio family portrait — young mother sitting cross-legged in white button-down shirt and dark brown wide-leg trousers holding a bouquet of vibrant orange tulips, her young son in white shirt and tan corduroy pants gently kissing her hand, warm brown seamless studio backdrop, soft directional lighting, photorealistic skin texture, professional family photography" },
    { id:"momchild-smiling-embrace", label:"Smiling Embrace", desc:"Floor Hug Joy",
      img: new URL("@/assets/templates/babies/momchild-smiling-embrace.jpg", import.meta.url).href,
      prompt:"as a realistic studio family portrait — young mother lying on her stomach with arms crossed under her chin beaming at camera in white long-sleeve shirt, her young daughter with curly hair in matching white long-sleeve shirt hugging her shoulders from behind laughing joyfully, plain light grey studio backdrop, soft studio lighting, photorealistic skin texture, professional family photography" },
    { id:"momchild-baby-steps", label:"Baby Steps", desc:"First Stand Together",
      img: new URL("@/assets/templates/babies/momchild-baby-steps.jpg", import.meta.url).href,
      prompt:"as a realistic studio family portrait — young mother in white t-shirt and blue jeans sitting cross-legged barefoot on a light wood floor supporting her standing baby in denim star-pattern overalls, white tee and white sneakers, warm peach-cream painted wall backdrop, soft natural light, photorealistic skin texture, professional family photography" },
    { id:"momchild-tender-kiss", label:"Tender Kiss", desc:"Standing On Mom's Lap",
      img: new URL("@/assets/templates/babies/momchild-tender-kiss.jpg", import.meta.url).href,
      prompt:"as a realistic studio profile family portrait — young mother in cream knotted-strap tank top and light blue jeans kneeling in profile, her young daughter in soft blue tee and jeans standing on her thighs, both puckering lips for a sweet kiss with foreheads almost touching, plain off-white seamless studio backdrop, soft studio lighting, photorealistic skin texture, professional family photography" },
    { id:"momchild-mother-son-hug", label:"Mother & Son Hug", desc:"Cozy Cream Sweaters",
      img: new URL("@/assets/templates/babies/momchild-mother-son-hug.jpg", import.meta.url).href,
      prompt:"as a realistic studio family portrait — young mother in soft cream ribbed sweater sitting cross-legged on the floor with her young son on her lap, boy in matching soft white sweater and blue jeans smiling widely with eyes closed as she hugs him cheek to cheek, charcoal grey textured studio backdrop, soft directional studio lighting, photorealistic skin texture, professional family photography" },
    { id:"momchild-sweet-surprise", label:"Sweet Surprise", desc:"Eyes Covered & Tulips",
      img: new URL("@/assets/templates/babies/momchild-sweet-surprise.jpg", import.meta.url).href,
      prompt:"as a realistic studio family portrait — young mother laughing joyfully holding a bouquet of pink and white tulips wrapped in pink ribbon, her young daughter with brown hair in two space buns standing behind her covering her eyes playfully with both small hands, both wearing soft beige sweaters, plain light grey studio backdrop, soft natural studio lighting, photorealistic skin texture, professional family photography" },
  ...
  couples: [
    { id:"cpl-sweet-embrace", label:"Sweet Embrace", desc:"Studio B&W Hug",
      img: new URL("@/assets/templates/couples/cpl-sweet-embrace.jpg", import.meta.url).href,
      prompt:"as an intimate black-and-white studio portrait — woman hugging man from behind over his shoulders, both smiling warmly, man in black tee and woman in white shirt, plain soft grey backdrop, editorial monochrome photography" },
    { id:"cpl-gentle-touch", label:"Gentle Touch", desc:"Sensual Chiaroscuro",
      img: new URL("@/assets/templates/couples/cpl-gentle-touch.jpg", import.meta.url).href,
      prompt:"as a sensual black-and-white portrait — man gently cupping woman's neck and chin, woman tilting head back with serene closed-eye expression, deep black backdrop, dramatic chiaroscuro lighting, editorial monochrome fashion photography" },
    { id:"cpl-timeless-tenderness", label:"Timeless Tenderness", desc:"All-Black Studio Hug",
      img: new URL("@/assets/templates/couples/cpl-timeless-tenderness.jpg", import.meta.url).href,
      prompt:"as a timeless black-and-white studio portrait — both wearing black, man embracing blonde woman from behind, her hands tenderly resting on his arms, both with peaceful closed-eye smiles, dark grey backdrop, editorial monochrome photography" },
    { id:"cpl-deeply-loving-gaze", label:"Deeply Loving Gaze", desc:"Cinematic Close-Up",
      img: new URL("@/assets/templates/couples/cpl-deeply-loving-gaze.jpg", import.meta.url).href,
      prompt:"as a cinematic black-and-white close-up — couple gazing deeply into each other's eyes with foreheads nearly touching, woman in white blouse, man in dark tee, soft side studio light, monochrome editorial photography" },
    { id:"cpl-eternal-promise", label:"Eternal Promise", desc:"Ring & Off-Shoulder",
      img: new URL("@/assets/templates/couples/cpl-eternal-promise.jpg", import.meta.url).href,
      prompt:"as a romantic black-and-white engagement portrait — woman in white off-shoulder dress proudly showing engagement ring on her finger, man behind in white shirt smiling against her shoulder, soft outdoor field, editorial monochrome photography" },
    { id:"cpl-sweet-moment", label:"Sweet Moment", desc:"Window Lamp Glow",
      img: new URL("@/assets/templates/couples/cpl-sweet-moment.jpg", import.meta.url).href,
      prompt:"as an intimate black-and-white portrait by a paned window with a vintage oil lamp on the sill, woman in cream knit sweater looking up smiling at man in dark shirt behind her, soft window light, editorial monochrome photography" },
    { id:"cpl-diamond-vow", label:"Diamond Vow", desc:"Forest Proposal Ring",
      img: new URL("@/assets/templates/couples/cpl-diamond-vow.jpg", import.meta.url).href,
      prompt:"as a black-and-white forest proposal portrait — young couple holding up a sparkling diamond engagement ring between their fingertips, man in black tee with silver chain resting head on smiling blonde woman, blurred forest background, editorial monochrome photography" },
    { id:"cpl-hugging-snow", label:"Hugging in the Snow", desc:"Snowy Forest Embrace",
      img: new URL("@/assets/templates/couples/cpl-hugging-snow.jpg", import.meta.url).href,
      prompt:"as a black-and-white winter portrait — couple embracing in a snowy forest path, man in dark wool coat, woman in chunky knit scarf and long coat looking up dreamily with a soft smile, falling snowflakes, cinematic monochrome editorial photography" },
    { id:"cpl-chin-hand", label:"Gazing with Chin in Hand", desc:"Profile Studio Smile",
      img: new URL("@/assets/templates/couples/cpl-chin-hand.jpg", import.meta.url).href,
      prompt:"as a black-and-white profile studio portrait — couple facing each other in profile, both resting chin on their hand with soft smiles gazing into each other's eyes, plain white tees, dark backdrop, editorial monochrome photography" },
    { id:"cpl-framed-love", label:"Framed by Love", desc:"Heart Hands Close-Up",
      img: new URL("@/assets/templates/couples/cpl-framed-love.jpg", import.meta.url).href,
      prompt:"as a joyful black-and-white close-up portrait — couple forming a heart shape with their hands framing their smiling faces together, soft natural light, intimate editorial monochrome photography" },
...
export const THEMES: Record<string, ThemeGroups> = {
  ...
  couples: {
    Seasons: [
      { id:"cp-winter", label:"Winter Romance", desc:"Snowfall Embrace", img:categoryCoupleImg,
    ...
    Occasions: [
      { id:"cp-wedding", label:"Wedding Day", desc:"Bride & Groom", img:categoryCoupleImg,
      ...
      { id:"cp-engagement", label:"Engagement", desc:"The Proposal", img:categoryCoupleImg,
  ...
  gifts: {
    Seasons: [
      { id:"gf-winter", label:"Winter Gift", desc:"Snowy Keepsake", img:categoryIndividualImg,
        prompt:"in a winter gift portrait with snowfall, cozy knitwear, twinkling lights and warm seasonal magic" },
      { id:"gf-autumn", label:"Autumn Gift", desc:"Harvest Tones", img:categoryIndividualImg,
        prompt:"in a warm autumn gift portrait with golden leaves, pumpkins and amber harvest light" },
      { id:"gf-spring", label:"Spring Gift", desc:"Floral Surprise", img:categoryIndividualImg,
        prompt:"in a fresh spring gift portrait with blooming florals, pastel light and joyful uplifting atmosphere" },
      { id:"gf-summer", label:"Summer Gift", desc:"Sunny Memory", img:categoryIndividualImg,
        prompt:"in a sunny summer gift portrait with golden beach light, warm tones and joyful summer atmosphere" },
    ],
    Holidays: [
      { id:"gf-xmas", label:"Christmas Gift", desc:"Under The Tree", img:categoryIndividualImg,
        prompt:"in a festive Christmas gift portrait with sparkling tree, gold ribbon, presents and warm fireside glow" },
      { id:"gf-mothersday", label:"Mother's Day", desc:"For Mom", img:categoryIndividualImg,
        prompt:"in a loving Mother's Day gift portrait with soft pastel florals, warm light and tender heartfelt mood" },
      { id:"gf-fathersday", label:"Father's Day", desc:"For Dad", img:categoryCoupleImg,
        prompt:"in a distinguished Father's Day gift portrait with warm wood tones, classic styling and proud heartfelt mood" },
      { id:"gf-valentine", label:"Valentine's Gift", desc:"Heartfelt Love", img:categoryCoupleImg,
        prompt:"in a romantic Valentine's gift portrait with red roses, candlelight, heart motifs and warm crimson tones" },
    ],
    Occasions: [
      { id:"gf-wedding", label:"Wedding Gift", desc:"Bridal Keepsake", img:categoryCoupleImg,
        prompt:"in a refined wedding gift portrait with white florals, soft veils, warm chandelier light and timeless bridal mood" },
      { id:"gf-anniv", label:"Anniversary Gift", desc:"Years Together", img:categoryCoupleImg,
        prompt:"in an elegant anniversary gift portrait with candles, soft florals and warm timeless romance" },
      { id:"gf-grad", label:"Graduation Gift", desc:"Cap & Diploma", img:categoryFamilyImg,
        prompt:"in a proud graduation gift portrait with cap, gown, diploma and university backdrop in warm celebratory light" },
      { id:"gf-housewarm", label:"Housewarming", desc:"New Home Gift", img:categoryFamilyImg,
        prompt:"in a warm housewarming gift portrait with charming home exterior, welcome wreath and joyful new-beginnings mood" },
    ],
  },
  occasions: {
    Seasons: [
      { id:"occ-s-winter", label:"Winter Occasion", desc:"Festive Cold Season", img:sceneMemorial,
        prompt:"in a magical winter setting with soft snow, warm layered clothing, and festive seasonal atmosphere" },
      { id:"occ-s-spring", label:"Spring Occasion", desc:"Fresh New Beginnings", img:categoryMaternityImg,
        prompt:"in a beautiful spring setting with blooming flowers, fresh air and the joy of new seasons" },
      { id:"occ-s-summer", label:"Summer Occasion", desc:"Warm Golden Hour", img:categoryIndividualImg,
        prompt:"in a warm summer outdoor portrait with golden afternoon light and beautiful natural backdrop" },
      { id:"occ-s-autumn", label:"Autumn Occasion", desc:"Harvest Season", img:sceneGifts,
        prompt:"in a rich autumn setting with golden and crimson leaves, harvest warmth and cozy atmosphere" },
    ],
    Holidays: [
      { id:"occ-h-xmas", label:"Christmas", desc:"Holiday Season Magic", img:categoryCoupleImg,
        prompt:"in a festive Christmas scene with twinkling lights, evergreen garlands, red and gold accents" },
      { id:"occ-h-val", label:"Valentine's Day", desc:"Love Celebration", img:categoryCoupleImg,
        prompt:"surrounded by red roses and candles, intimate romantic Valentine's portrait" },
      { id:"occ-h-easter", label:"Easter", desc:"Springtime Joy", img:categoryFamilyImg,
        prompt:"in a cheerful Easter portrait with pastel eggs, spring flowers and soft natural light" },
      { id:"occ-h-thanks", label:"Thanksgiving", desc:"Harvest Gratitude", img:categoryFamilyImg,
        prompt:"at a Thanksgiving harvest table with autumn gourds, golden corn and warm candlelight" },
    ],
    Occasions: [
      { id:"occ-o-bday", label:"Birthday", desc:"Celebrate Their Day", img:categoryCoupleImg,
        prompt:"in a colorful birthday celebration with balloons, confetti and joyful party atmosphere" },
      { id:"occ-o-anniv", label:"Anniversary", desc:"Milestone Celebration", img:categoryCoupleImg,
        prompt:"in a romantic anniversary setting with candles, florals and intimate warm light" },
    ],
  },
};

// 10 ready-made templates per sub-type filter. Used by tmplCards when a sub-type chip is active.
type _TmplDef = { label: string; desc: string; prompt: string };
const _mk = (img: string, defs: _TmplDef[]) =>
  defs.map((d, i) => ({ id: `st-${i}-${d.label.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`, img, ...d }));

export const SUBTYPE_TEMPLATES: Record<string, { id:string; label:string; desc:string; img:string; prompt:string }[]> = {
  baby: _mk(categoryBabyImg, [
    { label:"Royal Heir",         desc:"Velvet & tiny crown",      prompt:"as a royal baby prince or princess in silk christening gown with pearl accessories, opulent palace background, classical oil painting" },
    { label:"Renaissance Cherub", desc:"Old master nursery",       prompt:"as a renaissance cherub baby in soft drapery, old master oil painting with warm chiaroscuro lighting" },
    { label:"Sleepy Bear",        desc:"Cozy storybook nap",       prompt:"as a sleepy storybook baby tucked into white blankets cuddling a teddy bear, soft warm nursery light, whimsical illustrated mood" },
    { label:"Garden Fairy",       desc:"Magical nature sprite",    prompt:"as a tiny garden fairy with translucent wings, surrounded by oversized pastel flowers and dewdrops, soft magical light" },
    { label:"Space Baby",         desc:"Tiny astronaut",           prompt:"as an adorable infant astronaut floating among colorful planets and stars in a tiny spacesuit, playful cosmic background" },
    { label:"Cherub Angel",       desc:"Heaven-sent baby",         prompt:"as a classic cherub angel with soft white feathered wings floating among golden clouds in heavenly light" },
    { label:"Tiny Explorer",      desc:"Mini adventurer",          prompt:"as a tiny adventurer child in a pith helmet and explorer outfit, lush jungle and waterfall background, storybook style" },
    { label:"Dragon Rider",       desc:"Fantasy companion",        prompt:"as a baby riding a friendly cartoon dragon through cotton candy clouds wearing a tiny hero cape, fantasy sky" },
    { label:"Snow Princess",      desc:"Winter ice kingdom",       prompt:"as a baby snow princess in a sparkling ice gown with a snowflake crown, frozen castle and gentle snowfall background" },
    { label:"First Birthday",     desc:"Smash-cake joy",           prompt:"as a joyful toddler at first birthday celebration with a smash cake, balloons and confetti, candid cinematic light" },
  ]),
  couple: _mk(categoryCoupleImg, [
    { label:"Sweet Embrace",      desc:"Studio B&W hug",           prompt:"as an intimate black-and-white studio portrait of a couple embracing warmly, plain soft grey backdrop, editorial monochrome photography" },
    { label:"Royal Couple",       desc:"Coronation portrait pair", prompt:"as a royal couple in coronation robes with crown jewels, ornate palace interior, classical oil painting" },
    { label:"Renaissance Lovers", desc:"Old master romance",       prompt:"as renaissance lovers in 16th-century attire, dramatic chiaroscuro, old master oil painting" },
    { label:"Cinematic Couple",   desc:"Epic romance still",       prompt:"as a cinematic couple in a dramatic movie poster portrait, atmospheric lighting, deep contrast" },
    { label:"Sunset Pair",        desc:"Golden hour silhouette",   prompt:"as a couple silhouetted against a glowing sunset on a windswept hill, romantic painterly atmosphere" },
    { label:"Rainy Window",       desc:"Quiet rainy day",          prompt:"as a couple sharing a quiet moment by a rain-streaked window, soft warm interior light, cinematic" },
    { label:"Beach Tender",       desc:"Barefoot on shore",        prompt:"as a barefoot couple on a sandy beach at golden hour, intimate romantic candid, hyper-realistic photograph" },
    { label:"Forest Walk",        desc:"Hand-in-hand wander",      prompt:"as a couple walking hand-in-hand through a misty forest, dappled light, painterly and dreamy" },
    { label:"City Skyline",       desc:"Rooftop romance",          prompt:"as a couple embracing on a city rooftop at twilight with skyline lights, cinematic urban portrait" },
    { label:"Vintage Slow Dance", desc:"Ballroom black-and-white", prompt:"as a couple slow-dancing in a vintage ballroom, black-and-white film aesthetic, soft warm spotlights" },
  ]),
  family: _mk(categoryFamilyImg, [
    { label:"Family Heirloom",    desc:"Classical group oil",      prompt:"as a multi-generation family in a renaissance group oil painting, formal seated composition, warm chiaroscuro" },
    { label:"Royal Family",       desc:"Palace portrait",          prompt:"as a royal family group in regal attire with crowns and sashes, opulent palace background, classical oil painting" },
    { label:"Storybook Family",   desc:"Hand-drawn warmth",        prompt:"as a whimsical storybook family illustration with soft watercolor tones and cozy home scene" },
    { label:"Cinematic Family",   desc:"Movie-poster group",       prompt:"as a dramatic cinematic family portrait with deep contrast and atmospheric lighting" },
    { label:"Sunday Picnic",      desc:"Meadow gathering",         prompt:"as a family enjoying a sunny picnic in a wildflower meadow, warm candid documentary photo" },
    { label:"Fireplace Glow",     desc:"Cozy living room",         prompt:"as a family gathered by a warm fireplace at home, cozy intimate winter portrait" },
    { label:"Generations",        desc:"Grandparents to kids",     prompt:"as a multi-generation family portrait celebrating grandparents, parents and children together, warm timeless feel" },
    { label:"Beach Day",          desc:"Barefoot in sand",         prompt:"as a family playing barefoot on a sunlit beach, candid golden hour photograph" },
    { label:"Holiday Family",     desc:"Festive group",            prompt:"as a festive holiday family portrait by a decorated Christmas tree, warm string lights" },
    { label:"Minimal Family",     desc:"Clean studio group",       prompt:"as a clean minimal studio family portrait on soft neutral backdrop, modern editorial" },
  ]),
  individual: _mk(categoryIndividualImg, [
    { label:"Studio Headshot",    desc:"Clean editorial",          prompt:"as a clean editorial studio headshot on neutral backdrop, soft directional light, modern minimal" },
    { label:"Royal Portrait",     desc:"Crown & velvet",           prompt:"as 18th-century royalty in ermine robes and crown jewels, ornate palace background, classical oil painting" },
    { label:"Renaissance Noble",  desc:"Old master oil",           prompt:"as a renaissance noble in 16th-century attire, dramatic chiaroscuro, old master oil painting" },
    { label:"Cinematic Hero",     desc:"Movie poster portrait",    prompt:"as a dramatic cinematic action hero portrait with atmospheric backlight and deep contrast" },
    { label:"Storybook Self",     desc:"Whimsical illustration",   prompt:"as a whimsical hand-painted storybook portrait with warm tones and soft brushwork" },
    { label:"Fantasy Hero",       desc:"Mythic warrior",           prompt:"as a heroic fantasy warrior in ornate armor with mythic landscape background, painterly fantasy art" },
    { label:"Noir Detective",     desc:"B&W moody drama",          prompt:"as a noir detective in black-and-white film aesthetic with venetian-blind shadows, smoky atmosphere" },
    { label:"Editorial Cover",    desc:"Magazine cover look",      prompt:"as a high-fashion magazine cover editorial portrait with bold lighting and confident pose" },
    { label:"Golden Hour",        desc:"Sunlit candid",            prompt:"as a sunlit golden-hour outdoor portrait with warm rim light and soft natural background" },
    { label:"Minimal B&W",        desc:"Pure monochrome",          prompt:"as a refined minimal black-and-white studio portrait on plain backdrop, soft top light" },
  ]),
  graduation: _mk(categoryGraduationImg, [
    { label:"Cap & Gown",         desc:"Classic graduate",         prompt:"as a proud graduate in cap and gown holding a diploma, academic campus background, warm golden light" },
    { label:"Scholar Royal",      desc:"Regal graduation",         prompt:"as a graduate in regal robes with a golden tassel cap, ornate library background, classical oil painting" },
    { label:"Cinematic Grad",     desc:"Movie-poster moment",      prompt:"as a dramatic cinematic graduation portrait with confetti mid-air and atmospheric stage light" },
    { label:"Library Scholar",    desc:"Books & wisdom",           prompt:"as a graduate seated in a grand library surrounded by leather books, scholarly oil-painting aesthetic" },
    { label:"Diploma Joy",        desc:"Triumphant toss",          prompt:"as a graduate triumphantly tossing the academic cap into the sky at sunset, joyful candid photograph" },
    { label:"Family Pride",       desc:"With proud family",        prompt:"as a graduate embraced by proud family members in cap and gown, warm celebratory candid" },
    { label:"Campus Stroll",      desc:"Ivy & arches",             prompt:"as a graduate walking through ivy-covered campus arches in cap and gown, soft autumn light" },
    { label:"Storybook Scholar",  desc:"Whimsical academic",       prompt:"as a whimsical storybook graduate with tiny scholarly props, hand-painted illustration mood" },
    { label:"Minimal Diploma",    desc:"Clean studio grad",        prompt:"as a clean minimal studio graduation portrait holding a diploma on neutral backdrop" },
    { label:"Renaissance Doctor", desc:"Doctoral oil portrait",    prompt:"as a doctoral scholar in renaissance academic robes, old master oil painting with rich chiaroscuro" },
  ]),
  maternity: _mk(categoryMaternityImg, [
    { label:"Glowing Bump",       desc:"Soft window light",        prompt:"as an expecting mother glowing in soft natural window light, cradling her bump in a flowing gown, intimate maternity portrait" },
    { label:"Renaissance Mother", desc:"Madonna oil portrait",     prompt:"as an expecting mother in a Madonna-inspired renaissance oil painting, warm chiaroscuro lighting" },
    { label:"Royal Expectant",    desc:"Regal maternity",          prompt:"as a royal expecting mother in opulent silk gown with delicate tiara, palace interior, classical oil painting" },
    { label:"Field Bloom",        desc:"Wildflower meadow",        prompt:"as a pregnant mother walking through a sunlit wildflower meadow in a flowing dress, golden hour" },
    { label:"Storybook Mother",   desc:"Whimsical bump",           prompt:"as a whimsical storybook maternity scene with soft watercolor florals and dreamy mood" },
    { label:"Cinematic Mother",   desc:"Atmospheric portrait",     prompt:"as a dramatic cinematic maternity portrait with painterly backlight and soft shadow" },
    { label:"Beach Maternity",    desc:"Seaside bump",             prompt:"as an expecting mother walking barefoot on a quiet beach at sunset, flowing white dress, romantic" },
    { label:"Couple Maternity",   desc:"Partner embrace",          prompt:"as an expecting couple, partner gently cradling the bump with foreheads touching, warm tender portrait" },
    { label:"Floral Crown",       desc:"Garden goddess",           prompt:"as a maternity goddess in a flower crown surrounded by lush garden blooms, painterly soft light" },
    { label:"Minimal Bump",       desc:"Studio silhouette",        prompt:"as a clean minimal silhouette maternity studio portrait on neutral backdrop, soft side light" },
  ]),
  grandparents: _mk(categoryGrandparentsImg, [
    { label:"Wisdom Portrait",    desc:"Renaissance elder",        prompt:"as a renaissance-style portrait of a wise grandparent, deep chiaroscuro and old master oil painting" },
    { label:"Royal Elder",        desc:"Regal patriarch",          prompt:"as a royal elder in ermine robes and crown jewels, ornate palace background, classical oil painting" },
    { label:"Garden Bench",       desc:"Quiet afternoon",          prompt:"as grandparents sitting together on a garden bench in dappled afternoon light, warm candid photograph" },
    { label:"With Grandkids",     desc:"Generation hug",           prompt:"as grandparents lovingly hugging their grandchildren, warm intimate generational portrait" },
    { label:"Storybook Elders",   desc:"Whimsical wise pair",      prompt:"as whimsical storybook grandparents in cozy home scene, hand-painted illustration mood" },
    { label:"Cinematic Senior",   desc:"Movie-poster dignity",     prompt:"as a dramatic cinematic senior portrait with painterly light and dignified expression" },
    { label:"Fireplace Pair",     desc:"Cozy winter glow",         prompt:"as grandparents seated by a warm fireplace with a knit blanket, intimate cozy portrait" },
    { label:"Front Porch",        desc:"Rocking chair calm",       prompt:"as a grandparent on a sunlit front porch in a rocking chair with a cup of tea, soft candid mood" },
    { label:"Minimal Elder",      desc:"Clean studio",             prompt:"as a clean minimal studio senior portrait on neutral backdrop, soft directional light" },
    { label:"Heritage Family",    desc:"Multi-gen group",          prompt:"as grandparents at the center of a multi-generation family group, warm timeless oil-painting feel" },
  ]),
  friends: _mk(categoryFriendsImg, [
    { label:"Squad Goals",        desc:"Best friends group",       prompt:"as a tight group of best friends laughing together in casual streetwear, candid documentary photograph" },
    { label:"Rooftop Crew",       desc:"Skyline hangout",          prompt:"as a friend crew hanging out on a city rooftop at golden hour with skyline behind, cinematic" },
    { label:"Coffee Date",        desc:"Cozy cafe pair",           prompt:"as friends sharing coffee in a sunlit cozy cafe, warm candid lifestyle photograph" },
    { label:"Road Trip",          desc:"Open highway",             prompt:"as friends on an open-road trip leaning out of a convertible at sunset, joyful adventure mood" },
    { label:"Beach Day",          desc:"Sandy laughter",           prompt:"as friends laughing barefoot on a sunlit beach, vibrant candid summer photograph" },
    { label:"Storybook Squad",    desc:"Whimsical friends",        prompt:"as a whimsical storybook friend group illustration with warm tones and hand-painted style" },
    { label:"Cinematic Crew",     desc:"Movie-poster group",       prompt:"as a dramatic cinematic friend-group portrait with backlight and confident stance" },
    { label:"Forest Hike",        desc:"Trail adventure",          prompt:"as friends on a forest hiking trail in dappled light, candid adventure photograph" },
    { label:"Game Night",         desc:"Cozy indoor fun",          prompt:"as friends gathered around a game-night table with laughter and warm string lights, cozy indoor scene" },
    { label:"Editorial BFFs",     desc:"Fashion-mag look",         prompt:"as friends in a high-fashion magazine editorial group shot with bold lighting and confident pose" },
  ]),
  professional: _mk(categoryProfessionalImg, [
    { label:"LinkedIn Pro",       desc:"Modern headshot",          prompt:"as a polished professional LinkedIn headshot on a soft neutral backdrop, confident smile, modern editorial light" },
    { label:"Executive Suite",    desc:"Boardroom portrait",       prompt:"as a confident executive in a tailored suit inside a modern glass boardroom, cinematic corporate portrait" },
    { label:"Founder Story",      desc:"Office candid",            prompt:"as a startup founder in a sunlit modern office, candid documentary professional portrait" },
    { label:"Editorial Cover",    desc:"Magazine business",        prompt:"as a business-magazine cover editorial portrait with bold lighting and refined styling" },
    { label:"Renaissance CEO",    desc:"Oil-paint executive",      prompt:"as a renaissance-style CEO oil painting in tailored attire, dramatic chiaroscuro" },
    { label:"Royal Executive",    desc:"Regal leader",             prompt:"as a regal corporate leader in opulent attire with subtle crown motifs, classical oil painting" },
    { label:"Minimal Headshot",   desc:"Pure clean",               prompt:"as a refined minimal professional headshot on pure white backdrop, soft top light" },
    { label:"Author Portrait",    desc:"Thoughtful library",       prompt:"as a thoughtful author portrait seated in a warm library with leather books, professional editorial" },
    { label:"Speaker Stage",      desc:"Cinematic keynote",        prompt:"as a confident keynote speaker on stage with cinematic spotlight, professional portrait" },
    { label:"Brand Founder",      desc:"Workshop candid",          prompt:"as a brand founder in their workshop or studio environment, authentic professional documentary portrait" },
  ]),
  creator: _mk(categoryCreatorImg, [
    { label:"Editorial Creator",  desc:"Magazine-cover feel",      prompt:"as a content creator in a bold editorial magazine-cover portrait with confident pose and striking lighting" },
    { label:"Studio Setup",       desc:"Behind the camera",        prompt:"as a creator at their studio desk with ring light and camera setup, warm authentic creative environment" },
    { label:"Neon Night",         desc:"Cyberpunk influencer",     prompt:"as an influencer in a neon-lit urban night scene with cinematic cyberpunk color palette" },
    { label:"Artist At Work",     desc:"Paint-spattered focus",    prompt:"as an artist mid-creation in a paint-spattered studio, warm candid documentary portrait" },
    { label:"Vinyl Aesthetic",    desc:"Retro creator vibe",       prompt:"as a creator in a retro vinyl-record aesthetic with warm vintage tones and analog mood" },
    { label:"Renaissance Artist", desc:"Old-master self",          prompt:"as a renaissance-style artist self-portrait at an easel, dramatic chiaroscuro oil painting" },
    { label:"Pop Art Cover",      desc:"Bold graphic",             prompt:"as a bold pop-art editorial cover with high-saturation graphic styling" },
    { label:"Cinematic Creator",  desc:"Movie-poster portrait",    prompt:"as a dramatic cinematic creator portrait with atmospheric backlight and confident gaze" },
    { label:"Storybook Artist",   desc:"Whimsical illustration",   prompt:"as a whimsical storybook artist illustration with warm hand-painted tones" },
    { label:"Minimal Creator",    desc:"Clean modern",             prompt:"as a clean minimal studio creator portrait on neutral backdrop, modern editorial light" },
  ]),
  birthday: _mk(categoryIndividualImg, [
    { label:"Birthday Royalty",   desc:"Crown & cake",             prompt:"as birthday royalty wearing a crown beside a tall layered cake with candles, regal celebration oil painting" },
    { label:"Confetti Joy",       desc:"Candid celebration",       prompt:"as a joyful birthday portrait with confetti raining down, candid cinematic celebration photograph" },
    { label:"Balloon Wall",       desc:"Festive backdrop",         prompt:"as a birthday portrait against a colorful balloon-arch wall, bright joyful celebration" },
    { label:"Cake Smash",         desc:"Playful candid",           prompt:"as a playful birthday cake-smash portrait, candid laughter, vibrant party mood" },
    { label:"Spotlight Star",     desc:"Cinematic celebration",    prompt:"as a dramatic cinematic birthday spotlight portrait with stage light and confetti" },
    { label:"Storybook Party",    desc:"Whimsical birthday",       prompt:"as a whimsical storybook birthday illustration with hand-painted cake, balloons and warm tones" },
    { label:"Renaissance Feast",  desc:"Old-master party",         prompt:"as a renaissance birthday feast oil painting with candle-lit table and warm chiaroscuro" },
    { label:"Sparkler Night",     desc:"Night celebration",        prompt:"as a birthday portrait holding glowing sparklers at night, magical bokeh background" },
    { label:"Milestone Number",   desc:"Big-number balloons",      prompt:"as a birthday portrait with giant milestone number balloons, vibrant joyful celebration" },
    { label:"Minimal Birthday",   desc:"Clean studio cake",        prompt:"as a clean minimal studio birthday portrait with a single cake and soft directional light" },
  ]),
  wedding: _mk(categoryCoupleImg, [
    { label:"Wedding Day",        desc:"Cinematic still",          prompt:"as a cinematic wedding-day couple portrait with atmospheric light and timeless romance" },
    { label:"Royal Wedding",      desc:"Coronation-style vows",    prompt:"as a royal wedding couple in regal attire with crown jewels, ornate cathedral background, classical oil painting" },
    { label:"Renaissance Vows",   desc:"Old master union",         prompt:"as a renaissance wedding couple in 16th-century bridal attire, dramatic chiaroscuro oil painting" },
    { label:"Garden Ceremony",    desc:"Floral aisle",             prompt:"as a wedding couple under a flower-covered garden arch at golden hour, romantic candid photograph" },
    { label:"First Dance",        desc:"Ballroom glow",            prompt:"as a wedding couple sharing their first dance in a warmly-lit ballroom, cinematic black-tie" },
    { label:"Beach Vows",         desc:"Seaside wedding",          prompt:"as a barefoot wedding couple on a sunlit beach at sunset, flowing dress and soft tropical light" },
    { label:"Storybook Wedding",  desc:"Whimsical ceremony",       prompt:"as a whimsical storybook wedding illustration with hand-painted florals and warm tones" },
    { label:"Bridal Solo",        desc:"Veil & light",             prompt:"as a solo bridal portrait with flowing veil and soft window light, editorial wedding photograph" },
    { label:"Groom Portrait",     desc:"Confident solo",           prompt:"as a confident groom portrait in tailored tux, cinematic warm light" },
    { label:"Minimal Vows",       desc:"Clean ceremony",           prompt:"as a clean minimal modern wedding portrait on neutral backdrop, refined editorial styling" },
  ]),
  anniversary: _mk(categoryCoupleImg, [
    { label:"Anniversary Lovers", desc:"Years of love",            prompt:"as an anniversary couple holding hands with subtle anniversary symbols, warm timeless oil painting" },
    { label:"Renaissance Years",  desc:"Old master couple",        prompt:"as a renaissance-style anniversary couple oil painting with rich chiaroscuro" },
    { label:"Sunset Walk",        desc:"Beach hand-in-hand",       prompt:"as an anniversary couple walking hand-in-hand on a beach at sunset, romantic candid photograph" },
    { label:"Candlelit Dinner",   desc:"Intimate dinner",          prompt:"as an anniversary couple sharing a candlelit dinner, warm intimate cinematic portrait" },
    { label:"Garden Vows",        desc:"Floral renewal",           prompt:"as a couple renewing vows under a floral garden arch, golden-hour romantic photograph" },
    { label:"Storybook Anniversary", desc:"Whimsical years",      prompt:"as a whimsical storybook anniversary illustration with hand-painted hearts and warm tones" },
    { label:"Ballroom Dance",     desc:"Vintage slow dance",       prompt:"as an anniversary couple slow-dancing in a vintage ballroom, black-and-white film aesthetic" },
    { label:"Cinematic Years",    desc:"Movie-poster love",        prompt:"as a dramatic cinematic anniversary portrait with atmospheric backlight and tender embrace" },
    { label:"Family Toast",       desc:"Surrounded by loved ones", prompt:"as an anniversary couple toasted by family at a warm celebratory dinner, candid documentary" },
    { label:"Minimal Anniversary",desc:"Clean studio pair",        prompt:"as a clean minimal studio anniversary couple portrait on neutral backdrop" },
  ]),
  memorial: _mk(categoryIndividualImg, [
    { label:"In Loving Memory",   desc:"Royal tribute",            prompt:"as a memorial tribute portrait in royal frame with soft reverent light, classical oil painting" },
    { label:"Eternal Soul",       desc:"Renaissance memorial",     prompt:"as a renaissance-style memorial portrait with dignified chiaroscuro oil painting" },
    { label:"Sainted Memory",     desc:"Old master tribute",       prompt:"as an old-master memorial portrait with soft halo light and timeless reverence" },
    { label:"Little Angel",       desc:"Soft storybook tribute",   prompt:"as a soft storybook memorial illustration with gentle warm tones and tender mood" },
    { label:"Beyond The Veil",    desc:"Mythic memorial",          prompt:"as a fantasy memorial portrait with soft ethereal light and painterly atmosphere" },
    { label:"Final Frame",        desc:"Cinematic farewell",       prompt:"as a cinematic memorial portrait with atmospheric backlight and reverent stillness" },
    { label:"Quiet Remembrance",  desc:"Minimal tribute",          prompt:"as a clean minimal memorial portrait on neutral backdrop with soft directional light" },
    { label:"Light Remains",      desc:"Luminous tribute",         prompt:"as a soft luminous memorial portrait bathed in warm window light, intimate and reverent" },
    { label:"Garden Memorial",    desc:"Bloom remembrance",        prompt:"as a memorial portrait surrounded by soft garden blooms, painterly tribute mood" },
    { label:"Heirloom Frame",     desc:"Vintage family tribute",   prompt:"as a vintage heirloom memorial family portrait in soft sepia tones" },
  ]),
  "mothers-day": _mk(categoryIndividualImg, [
    { label:"Madonna Mother",     desc:"Renaissance mother",       prompt:"as a Madonna-inspired renaissance oil painting of a mother in warm chiaroscuro" },
    { label:"Royal Mother",       desc:"Regal maternal",           prompt:"as a regal royal mother in opulent silk gown with delicate tiara, classical oil painting" },
    { label:"Mother & Child",     desc:"Tender embrace",           prompt:"as a tender mother-and-child portrait with warm intimate light and soft candid mood" },
    { label:"Garden Mother",      desc:"Wildflower bloom",         prompt:"as a mother surrounded by garden wildflowers, golden-hour painterly photograph" },
    { label:"Storybook Mom",      desc:"Whimsical maternal",       prompt:"as a whimsical storybook mother illustration with hand-painted warmth" },
    { label:"Cinematic Mother",   desc:"Atmospheric portrait",     prompt:"as a dramatic cinematic mother portrait with painterly backlight and tender expression" },
    { label:"Mom & Kids",         desc:"Family of love",           prompt:"as a mother surrounded by her children laughing together, candid warm family portrait" },
    { label:"Minimal Mother",     desc:"Clean studio mom",         prompt:"as a clean minimal studio mother portrait on neutral backdrop, soft directional light" },
    { label:"Kitchen Warmth",     desc:"Home with kids",           prompt:"as a mother baking with her children in a sunlit kitchen, warm candid documentary photo" },
    { label:"Generational Moms",  desc:"Mother & grandmother",     prompt:"as a multi-generational portrait of mother, grandmother and child together, warm timeless feel" },
  ]),
  "fathers-day": _mk(categoryIndividualImg, [
    { label:"Father Patriarch",   desc:"Renaissance father",       prompt:"as a renaissance-style father patriarch oil painting in dramatic chiaroscuro" },
    { label:"Royal Father",       desc:"Regal paternal",           prompt:"as a regal royal father in ermine robes and crown jewels, classical oil painting" },
    { label:"Shoulders Of Dad",   desc:"Child on shoulders",       prompt:"as a father with his child joyfully on his shoulders at sunset, candid warm photograph" },
    { label:"Workshop Father",    desc:"Hands-on dad",             prompt:"as a father working in his garage workshop with warm task light, authentic documentary portrait" },
    { label:"Storybook Dad",      desc:"Whimsical paternal",       prompt:"as a whimsical storybook father illustration with hand-painted warmth" },
    { label:"Cinematic Father",   desc:"Movie-poster portrait",    prompt:"as a dramatic cinematic father portrait with atmospheric backlight and quiet strength" },
    { label:"Fishing Day",        desc:"Lakeside dad",             prompt:"as a father fishing at a calm lake at golden hour with his child, candid warm photograph" },
    { label:"Reading Together",   desc:"Storytime dad",            prompt:"as a father reading a book to his child in a cozy lamplit room, warm intimate portrait" },
    { label:"Minimal Father",     desc:"Clean studio dad",         prompt:"as a clean minimal studio father portrait on neutral backdrop, soft directional light" },
    { label:"Ranch Father",       desc:"Outdoor patriarch",        prompt:"as a father on a sunlit ranch in warm cinematic light, rugged candid portrait" },
  ]),
  christmas: _mk(categoryFamilyImg, [
    { label:"Tree Glow",          desc:"Decorated tree",           prompt:"as a warm Christmas portrait by a decorated tree with string lights, cozy candid photograph" },
    { label:"Fireplace Christmas",desc:"Stockings & hearth",       prompt:"as a Christmas portrait by a fireplace with hung stockings and warm fire glow" },
    { label:"Snowy Outdoor",      desc:"Winter wonderland",        prompt:"as a Christmas portrait outdoors in a snowy forest with falling snowflakes, magical winter light" },
    { label:"Santa Suit",         desc:"Festive Santa",            prompt:"as a portrait wearing a festive Santa suit with playful candid mood and warm holiday lights" },
    { label:"Storybook Christmas",desc:"Whimsical holiday",        prompt:"as a whimsical storybook Christmas illustration with hand-painted ornaments and warm cocoa tones" },
    { label:"Renaissance Holiday",desc:"Old-master winter",        prompt:"as a renaissance-style Christmas oil painting with candlelit feast and dramatic chiaroscuro" },
    { label:"Royal Holiday",      desc:"Regal Christmas",          prompt:"as a regal royal Christmas portrait in opulent winter attire with crown and holly, classical oil painting" },
    { label:"Cinematic Christmas",desc:"Movie-poster holiday",     prompt:"as a dramatic cinematic Christmas portrait with atmospheric snowfall and warm string lights" },
    { label:"Cocoa Pajamas",      desc:"Cozy morning",             prompt:"as a Christmas morning portrait in matching pajamas with cocoa mugs, cozy candid family scene" },
    { label:"Minimal Holiday",    desc:"Clean festive studio",     prompt:"as a clean minimal modern Christmas studio portrait with single ornament and soft directional light" },
  ]),
  valentines: _mk(categoryCoupleImg, [
    { label:"Heart Glow",         desc:"Romantic bokeh",           prompt:"as a romantic Valentine couple portrait with warm heart-shaped bokeh background, intimate candid" },
    { label:"Renaissance Love",   desc:"Old master romance",       prompt:"as a renaissance-style Valentine love oil painting with rich chiaroscuro" },
    { label:"Royal Valentines",   desc:"Regal romance",            prompt:"as a regal royal Valentine couple in opulent attire with rose motifs, classical oil painting" },
    { label:"Rose Petals",        desc:"Floral romance",           prompt:"as a Valentine couple surrounded by floating rose petals, soft warm romantic light" },
    { label:"Candlelit Dinner",   desc:"Intimate evening",         prompt:"as a Valentine couple at a candlelit dinner with rose centerpiece, cinematic warm portrait" },
    { label:"Storybook Valentine",desc:"Whimsical love",           prompt:"as a whimsical storybook Valentine illustration with hand-painted hearts and warm tones" },
    { label:"Cinematic Romance",  desc:"Movie-poster love",        prompt:"as a dramatic cinematic Valentine portrait with atmospheric backlight and tender gaze" },
    { label:"Sunset Embrace",     desc:"Golden hour kiss",         prompt:"as a Valentine couple sharing a golden-hour sunset embrace, romantic painterly photograph" },
    { label:"Letter Exchange",    desc:"Handwritten love",         prompt:"as a Valentine couple exchanging handwritten love letters in a sunlit room, intimate candid" },
    { label:"Minimal Heart",      desc:"Clean studio love",        prompt:"as a clean minimal studio Valentine couple portrait on neutral backdrop with single rose" },
  ]),
  retirement: _mk(categoryCoupleImg, [
    { label:"Golden Years",       desc:"Sunset couple",            prompt:"as a retired couple walking together at sunset, warm golden-hour candid photograph" },
    { label:"Garden Retirement",  desc:"Quiet garden joy",         prompt:"as a retired couple tending a sunlit garden together, warm candid documentary portrait" },
    { label:"Travel Retirement",  desc:"Adventure begins",         prompt:"as a retired couple at a scenic travel destination with backpacks, joyful adventure photograph" },
    { label:"Renaissance Honor",  desc:"Career legacy oil",        prompt:"as a renaissance-style retirement honor oil painting celebrating a distinguished career" },
    { label:"Cake & Toast",       desc:"Office celebration",       prompt:"as a retirement party portrait with cake and champagne toast, warm celebratory candid" },
    { label:"Porch Calm",         desc:"Rocking chair joy",        prompt:"as a retired couple on a sunlit front porch in rocking chairs with tea, intimate candid mood" },
    { label:"Storybook Retirement", desc:"Whimsical new chapter",  prompt:"as a whimsical storybook retirement illustration with warm hand-painted tones" },
    { label:"Cinematic Legacy",   desc:"Movie-poster retirement",  prompt:"as a dramatic cinematic retirement portrait with atmospheric warm backlight" },
    { label:"Grandkids Embrace",  desc:"Family of love",           prompt:"as a retired couple lovingly hugging their grandchildren, warm intimate generational portrait" },
    { label:"Minimal Retirement", desc:"Clean studio pair",        prompt:"as a clean minimal studio retirement couple portrait on neutral backdrop" },
  ]),
  engagement: _mk(categoryCoupleImg, [
    { label:"Ring Reveal",        desc:"Sparkling diamond",        prompt:"as an engagement couple holding up a sparkling diamond ring, joyful candid black-and-white editorial" },
    { label:"Forest Proposal",    desc:"Wooded romance",           prompt:"as a forest engagement portrait with woman showing the ring, warm dappled light and tender embrace" },
    { label:"Beach Engagement",   desc:"Seaside vow",              prompt:"as a barefoot engagement couple on a sunset beach with ring close-up, romantic photograph" },
    { label:"Rooftop Yes",        desc:"City skyline ring",        prompt:"as an engagement couple on a city rooftop at twilight with skyline behind, cinematic moment" },
    { label:"Renaissance Engagement", desc:"Old-master vow",       prompt:"as a renaissance-style engagement oil painting with rich chiaroscuro and tender embrace" },
    { label:"Royal Engagement",   desc:"Regal proposal",           prompt:"as a regal royal engagement portrait in opulent attire with crown jewels, classical oil painting" },
    { label:"Storybook Proposal", desc:"Whimsical ring",           prompt:"as a whimsical storybook engagement illustration with hand-painted hearts and warm tones" },
    { label:"Cinematic Vow",      desc:"Movie-poster moment",      prompt:"as a dramatic cinematic engagement portrait with atmospheric backlight and tender gaze" },
    { label:"Garden Bench",       desc:"Quiet proposal",           prompt:"as an engagement couple on a garden bench with ring reveal, soft golden-hour photograph" },
    { label:"Minimal Engagement", desc:"Clean studio ring",        prompt:"as a clean minimal studio engagement couple portrait on neutral backdrop with ring close-up" },
  ]),
  "new-home": _mk(categoryFamilyImg, [
    { label:"Keys In Hand",       desc:"New home keys",            prompt:"as a family holding new house keys in front of their new home, joyful candid documentary photograph" },
    { label:"Front Door Pose",    desc:"Doorway portrait",         prompt:"as a family portrait at the front door of their new home, warm golden-hour candid" },
    { label:"Moving Boxes",       desc:"Candid unpack",            prompt:"as a candid moving-day portrait surrounded by moving boxes in a sunlit empty living room" },
    { label:"Fireplace First",    desc:"First night in",           prompt:"as a family enjoying their first night in the new home by a warm fireplace, cozy intimate portrait" },
    { label:"Garden Bloom",       desc:"Backyard joy",             prompt:"as a family in their new backyard garden at golden hour, warm candid lifestyle photograph" },
    { label:"Storybook Home",     desc:"Whimsical housewarming",   prompt:"as a whimsical storybook housewarming illustration with hand-painted warmth" },
    { label:"Renaissance Home",   desc:"Old-master hearth",        prompt:"as a renaissance-style new-home oil painting with warm hearth and dramatic chiaroscuro" },
    { label:"Cinematic New Home", desc:"Movie-poster move",        prompt:"as a dramatic cinematic new-home family portrait with atmospheric warm light" },
    { label:"Pets In Place",      desc:"Family with pet",          prompt:"as a family with their pet exploring the new home together, warm candid photograph" },
    { label:"Minimal New Home",   desc:"Clean studio family",      prompt:"as a clean minimal studio family portrait on neutral backdrop celebrating a new home" },
  ]),
};
                ...
                {applyCollection(items as any, collection).map(t => {
                  ...
                  return (
                    <StyleCard key={`th-${t.id}`}
                      ...
                      confirming={confirming}
                      onZoom={(src) => setZoomImg({ src, label: t.label, desc: t.desc })}
  ...
  return (
    <div onClick={onSelect}
      ...
      <div style={{ position:"relative", aspectRatio:"4/5", overflow:"hidden", background:"#111" }}>
        ...
        {onZoom && (
          <button
            onClick={(e) => { e.stopPropagation(); onZoom(currentImg); }}
