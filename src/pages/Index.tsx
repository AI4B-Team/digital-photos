        ...
        <div style={{ maxWidth:1100, margin:"0 auto" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:18 }} className="pg3">
            {[
              ...
              { cat:"gifts",    img:sceneFathersReading, imgs:[sceneFathersReading, sceneFathersShoulders, sceneFathersGenerations, sceneFathersExecutive, sceneFathersRanch], Icon:Gift, title:"Father's Day", body:"Royal · Cinematic · Renaissance · Classic · +25 more", cta:"Create A Father's Day Portrait" },
            ].map(item => (
