...
export const TEMPLATES: Record<string, { id:string; label:string; desc:string; img:string; prompt:string }[]> = {
  pets: [
    ...
    { id:"pet-society",   label:"High Society",    desc:"Aristocrat Oil Painting",
      img: petHighSociety,
      prompt:"as a regal 18th century aristocrat, sitting in a red velvet armchair in a Victorian library reading an old book, dressed in an embroidered coat with lace cravat, warm earthy color palette, classical oil painting with painterly brushstrokes, gallery-quality fine art portrait" },
