    ...
    <div style={{ background:T.bg, minHeight:"100vh" }}>
      ...
      <section style={{ padding:"32px 32px 80px", background:T.bg }}>
        <div style={{ maxWidth:1100, margin:"0 auto" }}>
          ...
          <p style={{ fontSize:15, color:T.muted, textAlign:"center", marginBottom:48, lineHeight:1.65, fontFamily:"'Poppins',sans-serif", maxWidth:640, marginLeft:"auto", marginRight:"auto" }}>Choose from 30+ styles — Royal, Renaissance, Watercolor, Storybook and more for every moment.</p>
          <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:18 }} className="pg3">
            {[
              ...
              { cat:"couples",  img:sceneCouplesRings, imgs:[sceneCouplesRings, sceneCouplesKiss, sceneCouplesBackToBack, sceneCouplesEmbrace], Icon:Heart, title:"Couples", body:"Renaissance · Gothic · Gatsby · Royal · +25 more", cta:"Create A Couples Portrait" },
              ...
              { cat:"gifts",    img:sceneFathersShoulders, imgs:[sceneFathersShoulders, sceneFathersGenerations, sceneFathersReading, sceneFathersExecutive, sceneFathersRanch], Icon:Gift, title:"Father's Day", body:"Royal · Cinematic · Renaissance · Classic · +25 more", cta:"Create A Father's Day Portrait" },
            ].map(item => (
