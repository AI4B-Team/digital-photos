        ...
        <div style={{ maxWidth:1100, margin:"0 auto" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:18 }} className="pg3">
            {[
              ...
              { cat:"couples",  img:sceneCouplesRings, imgs:[sceneCouplesRings, sceneCouplesEditorialEmbrace, sceneCouplesCinematicKiss, sceneCouplesKiss, sceneCouplesBackToBack], Icon:Heart, title:"Couples", body:"Renaissance · Gothic · Gatsby · Royal · +25 more", cta:"Create A Couples Portrait" },
